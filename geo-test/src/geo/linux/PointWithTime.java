...
public class PointWithTime {
	//private String indexPath = "C:/Users/Administrator/Desktop/index/index11";
	
	private String indexPath = "E:\\data\\index\\index1";//	10亿数据 ID： 0~100000 坐标随机
	//private String indexPath = "E:\\data\\index\\index3";//1000000数据 
	//private String indexPath = "E:\\data\\index\\index15";//1000000数据 
	//private String dataPath = "E:\\data\\data\\geo.txt";	//10亿数据 ID： 0~100000 坐标随机
	//private String dataPath = "E:\\data\\data\\1millionWithTime.txt";	
	...
	public void searchByCircle(String field, double centerLon, double centerLat, double radiusMeters){
		try {
			//String indexPath = "C:/Users/Administrator/Desktop/index/index9";
		//	String indexPath = "E:\\data\\index\\index14";	//10亿数据 ID 0~100000 位置随机
			//String indexPath = "C:/Users/Administrator/Desktop/index/text3";
			//1.创建Directory
			Directory directory = FSDirectory.open(Paths.get(indexPath));
			//2.create IndexReader
			...
			for (ScoreDoc sd : collector.topDocs().scoreDocs) {
				...
				System.out.println("time:"+doc.get("time")+"\tId:"+doc.get("id")+"\tlocation:"+doc.get("location")
				+"\t"+GeoEncodingUtils.mortonUnhashLon(lo)
				+"\t"+GeoEncodingUtils.mortonUnhashLat(lo));
				*/
				System.out.println("time:"+doc.get("time")+"\tId:"+doc.get("id")+"\tlocation:"+doc.get("location")
	...
	public void searchByTimeRange( Long min, Long max, boolean minInclusive, boolean maxInclusive){
		String field = "time";
		try {
			//String indexPath = "C:/Users/Administrator/Desktop/index/index11";
		//	String indexPath = "E:\\data\\index\\index1";
			...
			IndexSearcher searcher =new IndexSearcher(reader);
			//4.创建搜索的Query
			Query query1= NumericRangeQuery.newLongRange(field, min, max, minInclusive, maxInclusive);
	...
	public static void main(String[] args){
		...
		PointWithTime tps =new PointWithTime();
		...
		//tps.searchByBBox(field, 101.0, 10.0, 105, 19.0);
		//tps.searchByCircle(field, 1, 1, 50000);
		//tps.searchById("10001");
		//tps.searchByIdRange(180, 19391, true, true);
		//tps.searchByTimeRange((long)50,(long) 90, true, true);
		Date end = new Date();
