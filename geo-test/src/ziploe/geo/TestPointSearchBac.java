...
public class TestPointSearchBac {
	...
	private String dataPath="///home/ziploe/zip-geo/data/data0";	//10亿数据 time id lon lat
	...
	public static void main(String[] args){
		...
		TestPointSearchBac tps =new TestPointSearchBac();
