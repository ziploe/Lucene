...
/**注释掉最下面的PorterStemFilter 则意味着对文本进行时态还原处理
 * 注释掉NuposLemmaFilter 意味着进行词干提取处理
 * 两者只能选择一个
 * @author 蒲路/Ziploe
 *
 */
public class MyEnglishAnalyzer extends StopwordAnalyzerBase{
	  ...
	  protected TokenStreamComponents createComponents(String fieldName) {
	    ...
	    //进行词干提取 使用 PorterStem提取规则 。 与下面的只能选一个
	    //result = new PorterStemFilter(result);
	    
	    //进行词态还原 使用修改后的 Nupos词典 与porter规则二选一
	    result = new NuposLemmaFilter(result);
