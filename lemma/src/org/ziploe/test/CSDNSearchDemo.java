 ...
 * public class CSDNSearchDemo {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		CSDNSearchDemo luceneDemo = new CSDNSearchDemo();		
		//create Lucene index
	 ...
	 *
	private void termQueryExample(){//定期查询
	 ...
	 *
	private void rangeQueryExample(){//范围查询
	 ...
	 *
	private void prefixQueryExample(){//前缀查询
	 ...
	 *
	private void booleanQueryExample(){//布尔查询
	 ...
	 *
	private void phraseQueryExample(){//短语查询
	 ...
	 *
	private void wildCardQueryExample(){//通配符查询
	...
	void sortBySenderExample(){//按发件人排序
